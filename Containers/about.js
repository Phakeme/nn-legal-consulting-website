            ...
            <About.Container>
                ...
                <About.Wrapper>
                        ...
                        <About.Ul>
                            ...
                            <About.Li>
                                <Link to="WHY-CHOOSE-US" spy={true} smooth={true} offset={-90} >
                                    <About.Heading href="#">WHY CHOOSE US</About.Heading>
                                </Link>
                                <ul>
                                    <About.SubHeading><a href="#">Name</a></About.SubHeading>
                                    <About.SubHeading><a href="#">Name</a></About.SubHeading>
                            ...
                            <About.Li>
                                <Link to="EXPERTISE" spy={true} smooth={true} offset={-90} >
                                    <About.Heading href="#section2">EXPERTISE</About.Heading>
                                </Link>
                                <ul>
                                    <About.SubHeading><a href="#">Name</a></About.SubHeading>
                                    <About.SubHeading><a href="#">Name</a></About.SubHeading>
                            ...
                            <About.Li>
                                <Link to="ENTERPRISE-SERVICES" spy={true} smooth={true} offset={-90} >
                                    <About.Heading>ENTERPRISE SERVICES</About.Heading>
                                </Link>
                                <ul>
                                    <About.SubHeading><a href="#">Name</a></About.SubHeading>
                                    <About.SubHeading><a href="#">Name</a></About.SubHeading>
                    ...
                    <About.DocWrapper>
                        ...
                        <h3 name="Who we are?">Who we are?</h3>
                        ...
                        <h3 name="Corporate citizenship?">Corporate citizenship?</h3>
                        ...
                        <h3 name="our focus and approach?">Our focus and approach?</h3>
                        ...
                        <h2>Our Correspondent services: </h2>
                        <ul>
                        ...
                        <h3>TRUSTS, WILLS AND ESTATES</h3>
                        ...
                        <h3>COMMERCIAL AND CORPORATE LAW</h3>
                        ...
                        <h3>SOCIAL ENGAGEMENT FACILITATION (ACCREDITED)</h3>
